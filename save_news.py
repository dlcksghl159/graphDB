...
DOC_DIR    = os.path.join(OUTPUT_ROOT, "documents")

os.makedirs(NEWS_DIR, exist_ok=True)

# -------------------------- 유틸 함수 ---------------------------

def save_docs(max_docs: int = 50):
    ...
    for i, art in enumerate(articles[:max_docs]):
        ...
        filepath = os.path.join(DOC_DIR, f"output_{i}.txt")
